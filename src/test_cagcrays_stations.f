...
c      
      ...
      ns=0
      do while (ios.eq.0)
      	read(1,"(1x,a7,3x,1f8.4,2x,1f8.4)",iostat=ios) a,b,c
...
c
      ...
      pathfilename='PATH_FILES/path_'//station_name
c      write(6,*) station_name
      write(6,*) pathfilename
c
