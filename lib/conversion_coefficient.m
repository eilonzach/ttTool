function [CC] = conversion_coefficient(R1,R2,rayp,alpha1,beta1,rho1,alpha2,beta2,rho2)
%[CC] = conversion_coefficient(R1,R2,rayp,alpha1,beta1,rho1,alpha2,beta2,rho2)
%
